...
@section('title', 'INDRACO – ' . ($title ?? 'Privacy Policy'))
...
<main id="content" tabindex="-1">
      ...
      <div class="container-sm banner">
         <div class="row banner-wrapper align-items-center">
            <div class="col col-12 z-0">
               <h2 class="banner-title text-uppercase">{{ $title ?? 'PRIVACY POLICY' }}</h2>
            </div>
            <div class="col col-6 z-2">
               <h3 class="banner-text">How We Protect &amp; Manage Your Personal Data.</h3>
            </div>
            <div class="col col-6 col-xxl-5 ms-auto z-1">
               <div class="banner-media">
                  <div class="banner-images-wrapper">
                     <img src="{{ asset('images/icon-contact.png') }}" alt="" class="banner-images">
                  </div>
   ...
   <!-- Content Section -->
   <section aria-label="Privacy Policy Content" class="container mb-5">
      <div class="bg-body-secondary p-4 p-md-5 rounded-4 shadow-sm">
         <div class="d-flex align-items-center justify-content-between mb-4 pb-3 border-bottom">
            <div>
               <span class="badge bg-custom-1 text-white px-3 py-2 rounded-pill mb-2">INDRACO Official Policy</span>
               <h1 class="h2 fw-bold text-custom-1 mb-0">{{ $title ?? 'Privacy Policy' }}</h1>
            </div>
